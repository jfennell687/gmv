...
function st_header_scripts() {
  ...
  $javascripts .= wp_enqueue_script('custom',get_bloginfo('template_url') ."/javascripts/app.js",array('jquery'),'1.2.3',true);
	...
	$javascripts .= wp_enqueue_script('anchor',get_bloginfo('template_url') ."/javascripts/jquery.anchor.js",array('jquery'),false,true);
...
function st_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Home First Box Widget Area', 'skeleton' ),
		'id' => 'first-box-widget-area',
		'description' => __( 'The first box widget area', 'skeleton' ),
	...
	register_sidebar( array(
		'name' => __( 'Home Second Box Widget Area', 'skeleton' ),
		'id' => 'second-box-widget-area',
		'description' => __( 'The second box widget area', 'skeleton' ),
		'before_widget' => '<div class="%1$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Home Third Box Widget Area', 'skeleton' ),
		'id' => 'third-box-widget-area',
		'description' => __( 'The third box widget area', 'skeleton' ),
		'before_widget' => '<div class="%1$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Home Fourth Box Widget Area', 'skeleton' ),
		'id' => 'fourth-box-widget-area',
		'description' => __( 'The fourth box widget area', 'skeleton' ),
		'before_widget' => '<div class="%1$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Home Page Widget Area', 'skeleton' ),
		'id' => 'home-widget-area',
		'description' => __( 'Shown only on the Home Page', 'skeleton' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
add_action('st_header','st_header_extras', 3);
...
add_action('st_header','st_logo', 4);
...
function st_navbar() {
	echo '<div id="navigation" class="row">';
	wp_nav_menu( array( 'menu' => 'Main Menu', 'container_class' => 'menu-header container', 'theme_location' => 'primary'));
	echo '</div><!--/#navigation-->';
}
...
if ( !function_exists( 'st_before_content' ) ) {
	...
	function st_before_content($columns, $sidebar = FALSE) {
	// 
...
if ( !function_exists( 'after_sidebar' ) ) {
	...
	// Additional Content could be added here
	   echo '</div><!-- #sidebar -->';
		...
		if(!cat_is_ancestor_of(4, $cat_id) && !is_page_template('page-parent-summary.php'))
		{
...
if (!function_exists('st_before_footer'))  {
    function st_before_footer() {
			...
			echo '<div class="clear"></div><div id="footer_wrapper"><div id="footer_top"></div><div id="footer" class="'.$class.' container">';
    }
}
