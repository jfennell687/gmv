 ...
 $options[] = array( "name" => "(H5) Heading Typography",
  ...
  $options[] = array( "name" => "Extra Header Text",
	...
	$options[] = array( "name" => "Home Page",
						"type" => "heading");
	$options[] = array( "name" => "Main Text Title",
						"desc" => "HTML or text to be inserted on the Home Page.",
						"id" => "home_main_title",
						"std" => "",
						"type" => "text"); 
	$options[] = array( "name" => "Main Text Box",
						"desc" => "HTML or text to be inserted on the Home Page.",
						"id" => "home_main_text",
						"std" => "",
						"type" => "textarea"); 
	$options[] = array( "name" => "Video Spotlight - You Tube Link",
						"desc" => "A You Tube link to show in the Video Spotlight Section.",
						"id" => "video_spotlight",
						"std" => "",
						"type" => "text"); 
	return $options;
