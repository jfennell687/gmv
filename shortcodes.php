...
function st_newsletter($atts, $content = null) {
	...
	// container
	$result='<div id="newsletter-cats" class="latestposts">';
	...
	foreach($categories as $category)
	{
		...
		$result.='<div class="latest-title"><a href="' . get_category_link( $category->term_id ) . '" title="' . sprintf( __( "View all posts in %s" ), $category->name ) . '" ' . '>' . $category->name.'</a></div>';
...
add_shortcode("newsletter", "st_newsletter");
